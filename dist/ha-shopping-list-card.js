...
`,Nt=[{name:"entity",required:!0,selector:{entity:{domain:"todo"}}},{type:"expandable",name:"_grp_header",title:"Header",icon:"mdi:format-title",flatten:!0,schema:[{name:"show_header",selector:{boolean:{}}},{name:"title",selector:{text:{}}},{name:"icon",selector:{icon:{}}}]},{type:"expandable",name:"_grp_list",title:"To-do items",icon:"mdi:format-list-bulleted",flatten:!0,schema:[{name:"sort",selector:{select:{mode:"dropdown",options:[{value:"manual",label:"Manual (HA order)"},{value:"alpha",label:"Alphabetical"},{value:"created",label:"Created order"}]}}},{name:"click_to_check",selector:{boolean:{}}},{name:"enable_edit",selector:{boolean:{}}},{name:"enable_remove",selector:{boolean:{}}},{name:"empty_message",selector:{text:{}}}]},{type:"expandable",name:"_grp_quantity",title:"Quantities",icon:"mdi:counter",flatten:!0,schema:[{name:"enable_quantity",selector:{boolean:{}}},{name:"quantity_max",selector:{number:{min:0,max:9999,step:1,mode:"box"}}}]},{type:"expandable",name:"_grp_completed",title:"Completed items",icon:"mdi:check-circle-outline",flatten:!0,schema:[{name:"completed",selector:{select:{mode:"dropdown",options:[{value:"bottom",label:"At the bottom of the list"},{value:"inline",label:"Mixed with active items"},{value:"collapse",label:"Collapsible section"},{value:"hide",label:"Hide completed items"}]}}},{name:"completed_label",selector:{text:{}}}]},{type:"expandable",name:"_grp_add",title:"Add items",icon:"mdi:plus-circle-outline",flatten:!0,schema:[{name:"show_add_input",selector:{boolean:{}}},{name:"add_input_position",selector:{select:{mode:"dropdown",options:[{value:"bottom",label:"Bottom (below the list)"},{value:"top",label:"Top (below the header)"}]}}},{name:"add_button_label",selector:{text:{}}}]}],It=[{name:"enable_categories",selector:{boolean:{}}},{name:"group_by_category",selector:{boolean:{}}},{name:"category_collapsible",selector:{boolean:{}}},{name:"category_check_all",selector:{boolean:{}}},{name:"general_category_label",selector:{text:{}}}];let Rt=class extends rt{constructor(){super(...arguments),this._labelFor=t=>{if("type"in t&&"expandable"===t.type)return t.title??t.name;return{entity:"Todo Entity (required)",title:"Title",icon:"Icon",show_header:"Show header",completed:"Show completed items",completed_label:"Completed group label",show_add_input:"Show add-item input",add_input_position:"Add bar position",add_button_label:"Add button label",empty_message:"Empty list message",sort:"Sort order",click_to_check:"Click row to check/uncheck",enable_edit:"Allow editing items",enable_remove:"Allow removing items",enable_quantity:"Enable quantities",quantity_max:"Maximum quantity (0 = unlimited)",enable_categories:"Enable categories",group_by_category:"Group items by category",category_collapsible:"Allow collapsing categories",category_check_all:"Allow check-all on categories",general_category_label:"Label for uncategorized items"}[t.name]??t.name}}setConfig(t){this._config=t}render(){if(!this.hass||!this._config)return L``;const t={...St,...this._config};return L`
      ...
      <details class="customization">
        ...
        <div class="customization-body">
          ...
          <ha-code-editor
            mode="yaml"
            .value=${e=void 0!==this._config.category_colors?this._config.category_colors:zt,e?Object.entries(e).map(([t,e])=>`${t}: ${e}`).join("\n"):""}
  ...
  `,t([ht({attribute:!1})],Rt.prototype,"hass",void 0),t([gt()],Rt.prototype,"_config",void 0),Rt=t([ct(Ct)],Rt);const Dt=window;Dt.customCards=Dt.customCards||[],Dt.customCards.find(t=>t.type===Et)||Dt.customCards.push({type:Et,name:"Shopping List Card",description:"A shopping-style list view for any todo entity, with categories and quantities.",preview:!0,documentationURL:"https://github.com/MCuello17/ha-shopping-list"}),console.info("%c SHOPPING-LIST-CARD %c v0.1.0 ","color: white; background: #03a9f4; font-weight: 700;","color: #03a9f4; background: white; font-weight: 700;");let jt=class extends rt{constructor(){super(...arguments),this._items=[],this._loading=!1,this._draft="",this._completedExpanded=!1,this._editDraft="",this._editQuantity=1,this._addQuantity=1,this._collapsedCategories=new Set,this._focusEditOnUpdate=!1,this._toggleCompletedExpanded=()=>{this._completedExpanded=!this._completedExpanded}}static getStubConfig(){return{...St}}static async getConfigElement(){return document.createElement(Ct)}setConfig(t){if(!t)throw new Error("Invalid configuration");const e={...t};void 0===e.completed&&void 0!==e.show_completed&&(e.completed=e.show_completed?"inline":"hide"),this._config={...St,...e}}getCardSize(){return(this._config?.show_header?2:1)+Math.min(this._items.length,6)}disconnectedCallback(){super.disconnectedCallback(),this._teardownSubscription()}updated(t){if(super.updated(t),this._focusEditOnUpdate){const t=this.renderRoot.querySelector(".sl-edit-input");t&&(t.focus(),t.select(),this._focusEditOnUpdate=!1)}const e=this._config?.entity;e&&this.hass&&e!==this._lastEntity&&(this._lastEntity=e,this._setupSubscription(e))}async _setupSubscription(t){if(this._teardownSubscription(),this.hass){this._loading=!0,this._error=void 0;try{const e=await this.hass.callWS({type:"todo/item/list",entity_id:t});this._items=e.items??[],this._unsub=await this.hass.connection.subscribeMessage(t=>{this._items=t.items??[]},{type:"todo/item/subscribe",entity_id:t})}catch(t){this._error=t instanceof Error?t.message:String(t)}finally{this._loading=!1}}}_teardownSubscription(){if(this._unsub){try{this._unsub()}catch{}this._unsub=void 0}}async _addItem(){const t=this._config,e=t?.entity,i=this._draft.trim();if(!e||!i||!this.hass)return;const s=t.enable_quantity??!1,o=Ht(this._addQuantity,t.quantity_max??0),n=s?Mt(i,o):i;try{await this.hass.callService("todo","add_item",{entity_id:e,item:n}),this._draft="",this._addQuantity=1}catch(t){this._error=t instanceof Error?t.message:String(t)}}_adjustAddQuantity(t){const e=this._config?.quantity_max??0;this._addQuantity=Ht(this._addQuantity+t,e)}async _toggleItem(t){const e=this._config?.entity;if(!e||!this.hass)return;const i="completed"===t.status?"needs_action":"completed";try{await this.hass.callService("todo","update_item",{entity_id:e,item:t.uid,status:i})}catch(t){this._error=t instanceof Error?t.message:String(t)}}async _removeItem(t){const e=this._config?.entity;if(e&&this.hass)try{await this.hass.callService("todo","remove_item",{entity_id:e,item:t.uid})}catch(t){this._error=t instanceof Error?t.message:String(t)}}async _toggleCategoryAll(t,e){const i=this._config?.entity;if(!i||!this.hass||0===t.length)return;const s=e?"needs_action":"completed",o=t.filter(t=>t.status!==s);for(const t of o)try{await this.hass.callService("todo","update_item",{entity_id:i,item:t.uid,status:s})}catch(t){return void(this._error=t instanceof Error?t.message:String(t))}}_toggleCategoryCollapse(t){const e=new Set(this._collapsedCategories);e.has(t)?e.delete(t):e.add(t),this._collapsedCategories=e}_categoryColor(t){const e=this._config;return(void 0!==e.category_colors?e.category_colors:zt)[t]}_startEdit(t){if(this._config?.enable_quantity??!1){const{name:e,quantity:i}=Ot(t.summary);this._editDraft=e,this._editQuantity=i}else this._editDraft=t.summary,this._editQuantity=1;this._editingUid=t.uid,this._focusEditOnUpdate=!0}_cancelEdit(){this._editingUid=void 0,this._editDraft="",this._editQuantity=1}async _saveEdit(t){if(this._editingUid!==t.uid)return;const e=this._config;if(!e)return void this._cancelEdit();const i=this._editDraft.trim();if(!i)return void this._cancelEdit();const s=e.enable_quantity??!1?Mt(i,Ht(this._editQuantity,e.quantity_max??0)):i;if(s===t.summary)return void this._cancelEdit();const o=e.entity;if(o&&this.hass){this._cancelEdit();try{await this.hass.callService("todo","update_item",{entity_id:o,item:t.uid,rename:s})}catch(t){this._error=t instanceof Error?t.message:String(t)}}else this._cancelEdit()}_adjustEditQuantity(t){const e=this._config?.quantity_max??0;this._editQuantity=Ht(this._editQuantity+t,e)}_sort(t){const e=this._config?.sort;return"alpha"===e?[...t].sort((t,e)=>t.summary.localeCompare(e.summary)):t}_splitItems(){const t=[],e=[];for(const i of this._items)"completed"===i.status?e.push(i):t.push(i);return{active:this._sort(t),completed:this._sort(e)}}_buildGroups(){const t=this._config,e=t.general_category_label||"General",i=new Map,s=[];for(const t of this._items){const{category:o}=Pt(t.summary),n=o??"__general__";let a=i.get(n);a||(a={key:n,category:o,displayName:o??e,active:[],completed:[]},i.set(n,a),s.push(n)),"completed"===t.status?a.completed.push(t):a.active.push(t)}const o=s.map(t=>{const e=i.get(t);return{...e,active:this._sort(e.active),completed:this._sort(e.completed)}});return"alpha"===t.sort&&o.sort((t,e)=>t.displayName.localeCompare(e.displayName)),o}render(){if(!this._config||!this.hass)return V;const t=this._config,e=this._extractCustomStyle(),i=!(!t.show_add_input||!t.entity),s=t.add_input_position??"bottom";return L`
    ...
    `}_extractCustomStyle(){const t=this._config;if(t){if("string"==typeof t.style&&t.style.trim())return t.style;if(t.card_mod){if("string"==typeof t.card_mod)return t.card_mod;if("object"==typeof t.card_mod&&t.card_mod.style)return t.card_mod.style}}}};jt.styles=Tt,t([ht({attribute:!1})],jt.prototype,"hass",void 0),t([gt()],jt.prototype,"_config",void 0),t([gt()],jt.prototype,"_items",void 0),t([gt()],jt.prototype,"_loading",void 0),t([gt()],jt.prototype,"_error",void 0),t([gt()],jt.prototype,"_draft",void 0),t([gt()],jt.prototype,"_completedExpanded",void 0),t([gt()],jt.prototype,"_editingUid",void 0),t([gt()],jt.prototype,"_editDraft",void 0),t([gt()],jt.prototype,"_editQuantity",void 0),t([gt()],jt.prototype,"_addQuantity",void 0),t([gt()],jt.prototype,"_collapsedCategories",void 0),jt=t([ct(Et)],jt);export{jt as ShoppingListCard};
